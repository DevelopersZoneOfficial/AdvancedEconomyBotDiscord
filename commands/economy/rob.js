...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    let embed2 = new MessageEmbed()
      .setColor("GREEN")
      .setDescription(`<a:nahin:885441031171112990> You cannot rob yourself`)
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
      ...
      let timeEmbed = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<a:nahin:885441031171112990> You have already robbed someone\n\nTry again in ${time.minutes}m ${time.seconds}s `);
      message.channel.send(timeEmbed)
    } else {

      let moneyEmbed = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<a:nahin:885441031171112990> You need atleast 100 coins in your wallet to rob someone`);
      ...
      let moneyEmbed2 = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<a:nahin:885441031171112990> ${user.user.username} does not have anything you can rob`);
      ...
      if (targetuser < random) {
        ...
        let embed = new MessageEmbed()
          .setDescription(`<:economye:899658979217641492> You robbed ${user.user.username} and got away with ${random} coins`)
          .setColor("GREEN")
